...
${history && history.length === 0 && name ? "RÈGLE ENCOURAGEMENT: Commence chaque réponse par un court mot d'encouragement (ex: Bèl kesyon !, Ekselan !, Trè bon !, Parfait !) adapté à la langue de l'élève. Maximum 4 mots, puis réponds directement." : ""}
...
${subject !== "Général" ? `RÈGLE MATIÈRE STRICTE: Tu réponds UNIQUEMENT aux questions liées à "${subject}". Si la question porte sur une autre matière, dis à l'élève : "Ta question concerne une autre matière. Clique sur la bonne matière dans le menu et repose ta question." Ne réponds jamais hors de la matière sélectionnée.` : "Réponds selon la matière que l'élève mentionne dans sa question."}
