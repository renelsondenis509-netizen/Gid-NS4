...
export const BADGES = [
  ...
  { id:"master",        svg:'<svg viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="2" strokeLinecap="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>',            label:"Maèt",           color:"#a855f7", desc:"3 matye ak 20/20"    },
  // ── Quiz ──
  ...
  // ── Exercices ──
  { id:"first_exo",     svg:'<svg viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="2" strokeLinecap="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>',label:"Pratisyan",     color:"#34d399", desc:"1e egzèsis fini"     },
  { id:"exo_10",        svg:'<svg viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>',               label:"Asidye",         color:"#10b981", desc:"10 egzèsis fini"     },
  // ── Couverture ──
  ...
  { id:"cover_50",      svg:'<svg viewBox="0 0 24 24" fill="none" stroke="#ef4444" strokeWidth="2" strokeLinecap="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>',                                                                  label:"Chalanman",      color:"#ef4444", desc:"50% matye eseye"     },
  ...
  { id:"streak_5",      svg:'<svg viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="2" strokeLinecap="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>',                                                                                label:"Sou Dife",       color:"#f59e0b", desc:"5 fwa 16+ nan yon matye" },
];
