...
médicaments (25% viennent de plantes), alimentation, équilibre écosystémique." },
    { q: "La phagocytose est :", choices: ["La production d'anticorps", "Le processus par lequel des cellules (macrophages) englobent et detruisent les agents pathogenes", "La reaction inflammatoire", "La secretion d'interferons"], answer: 1, note: "Phagocytose : adhesion, ingestion (phagosome), digestion (lysosomes), rejet. Realisee par neutrophiles et macrophages." },
    { q: "Un antigene est :", choices: ["Un anticorps", "Toute substance etrangere capable de declencher une reponse immunitaire specifique", "Un globule blanc", "Une hormone"], answer: 1, note: "Antigene : substance reconnue comme non-soi. Possede des epitopes reconnus par les lymphocytes." },
    { q: "Les lymphocytes B et T sont produits dans :", choices: ["Le thymus uniquement", "La moelle osseuse rouge — les T migrent vers le thymus, les B maturent dans la moelle", "La rate", "Les ganglions"], answer: 1, note: "Lymphocytes B : maturation dans la moelle. Lymphocytes T : migration vers le Thymus pour maturation." },
    { q: "L'immunite humorale est assuree par :", choices: ["Les lymphocytes T cytotoxiques", "Les lymphocytes B produisant des anticorps circulant dans le sang", "Les macrophages", "Les cellules NK"], answer: 1, note: "Immunite humorale : Ag -> lymphocyte B -> plasmocytes (secretent anticorps) + cellules memoire B." },
    { q: "Un anticorps est :", choices: ["Une cellule immunitaire", "Une glycoproteine en forme de Y produite par les plasmocytes — 5 classes : IgG, IgA, IgM, IgE, IgD", "Un virus modifie", "Une enzyme"], answer: 1, note: "Anticorps : structure en Y. IgG (principale), IgA (secretions), IgM (premiere reponse), IgE (allergie)." },
    { q: "Les cellules memoires immunitaires permettent :", choices: ["La reaction inflammatoire initiale", "Une reponse secondaire plus rapide et intense lors d'une reexposition — base de la vaccination", "La phagocytose", "La production d'interferons"], answer: 1, note: "Cellules memoire B et T : vie longue. Reponse secondaire plus rapide et forte. Principe de la vaccination." },
    { q: "Une hormone est :", choices: ["Un neurotransmetteur uniquement", "Un messager chimique secreté par une glande endocrine agissant sur un organe cible via le sang", "Une enzyme digestive", "Un anticorps"], answer: 1, note: "Hormone : secretee dans le sang (glande endocrine) -> organe cible (recepteur specifique) -> reponse physiologique." },
    { q: "La thyroide secrete principalement :", choices: ["L'insuline et le glucagon", "La thyroxine (T4) et la T3 (metabolisme) + calcitonine (calcium)", "L'adrenaline", "L'ADH"], answer: 1, note: "Thyroide : T3/T4 -> stimulent metabolisme de base, croissance. Calcitonine -> baisse calcemie. Iode indispensable." },
    { q: "Le pancreas est une glande :", choices: ["Uniquement endocrine", "Uniquement exocrine", "Amphicrine : exocrine (sucs digestifs) + endocrine (insuline/glucagon — ilots de Langerhans)", "Neuroendocrine"], answer: 2, note: "Pancreas amphicrine : acini (sucs digestifs) + ilots de Langerhans : cellules beta (insuline) + cellules alpha (glucagon)." },
    { q: "L'insuline agit en :", choices: ["Augmentant la glycemie", "Diminuant la glycemie — stimule l'entree du glucose dans les cellules et la glycogenogenese hepatique", "N'ayant aucun effet sur la glycemie", "Stimulant la lipolyse"], answer: 1, note: "Insuline (cellules beta) : hyperglycemie -> insuline -> glucose entre dans cellules -> glycemie baisse. Deficit -> diabete." },
    { q: "Les bacteries sont des organismes :", choices: ["Eucaryotes pluricellulaires", "Procaryotes unicellulaires — sans noyau membranaire, ADN circulaire", "Acellulaires comme les virus", "Eucaryotes unicellulaires"], answer: 1, note: "Bacteries : procaryotes, 1-10 um. Paroi (peptidoglycane), ribosomes 70S, ADN circulaire, parfois flagelle." },
    { q: "Les principales formes bacteriennes sont :", choices: ["Ronde, triangulaire, carree", "Coque (spherique), bacille (batonnet), spirille (spirale), vibrion (virgule)", "Cylindrique, plate, etoilee", "Hexagonale et ovale"], answer: 1, note: "Coques (Staphylococcus), bacilles (E. coli), spirilles, vibrions (Vibrio cholerae). Base de l'identification morphologique." },
    { q: "Les virus se distinguent des bacteries car :", choices: ["Ils sont plus grands", "Ils sont acellulaires — acide nucleique + capside, parasites intracellulaires obligatoires, non sensibles aux antibiotiques", "Ils se reproduisent seuls", "Ils ont une paroi bacterienne"], answer: 1, note: "Virus : acellulaires, 20-400 nm. Genome (ADN ou ARN) + capside. Parasites obligatoires. Non sensibles aux antibiotiques." },
    { q: "Le neurone est :", choices: ["La cellule de soutien du SN", "L'unite structurale et fonctionnelle du systeme nerveux — corps cellulaire + axone + dendrites", "Un globule blanc specialise", "Une cellule musculaire"], answer: 1, note: "Neurone : soma + dendrites (receptrices) + axone (emetteur). Myeline accelere la conduction (1-120 m/s)." },
    { q: "La synapse est :", choices: ["Un ganglion nerveux", "La jonction entre deux neurones — influx transmis chimiquement par des neurotransmetteurs", "Le noyau du neurone", "Une cellule gliale"], answer: 1, note: "Synapse chimique : vesicules de neurotransmetteurs -> fente synaptique -> recepteurs postsynaptiques -> depolarisation." },
    { q: "Le daltonisme est une maladie :", choices: ["Autosomique dominante", "Liee au chromosome X, recessive — touche surtout les hommes (XY)", "Autosomique recessive", "Liee au chromosome Y"], answer: 1, note: "Daltonisme : gene sur chromosome X. Homme XY : un seul allele X -> exprime la maladie. Frequence : 8% hommes, 0,5% femmes." },
    { q: "La trisomie 21 est causee par :", choices: ["Une mutation genique ponctuelle", "La presence de 3 chromosomes 21 (2n=47) — erreur de disjonction meiotique", "Une deletion chromosomique", "Une translocation uniquement"], answer: 1, note: "Trisomie 21 : 47 chromosomes. Non-disjonction lors de la meiose. Risque augmente avec l'age maternel." },
    { q: "Un ecosysteme est :", choices: ["Un ensemble d'individus de la meme espece", "L'ensemble forme par la biocenose (etres vivants) et le biotope (milieu physique) en interaction", "Un habitat uniquement", "Une communaute d'animaux"], answer: 1, note: "Ecosysteme : biocenose + biotope. Interactions : chaines alimentaires, cycles biogeochimiques, flux d'energie." },
## ],
...
groupe 17 (VIIA)." },
    { q: "Qu'est-ce que la geologie ?", choices: ["La science des astres", "La science de la Terre — etude de sa structure, composition et histoire", "La science de l'Univers", "La science des etres vivants"], answer: 1, note: "Geologie = science de la Terre. Cosmologie = science de l'Univers. Astronomie = science des astres." },
    { q: "Les quatre couches de l'atmosphere de bas en haut sont :", choices: ["Stratosphere, troposphere, mesosphere, thermosphere", "Troposphere, stratosphere, mesosphere, thermosphere", "Ionosphere, troposphere, stratosphere, exosphere", "Mesosphere, thermosphere, troposphere, stratosphere"], answer: 1, note: "Troposphere (0-15 km) -> stratosphere (15-50 km, couche d'ozone) -> mesosphere (50-85 km) -> thermosphere (85-500 km)." },
    { q: "La structure interne de la Terre comprend :", choices: ["Deux couches uniquement", "Trois couches : croute terrestre, manteau, noyau", "Quatre couches egales", "Une seule couche homogene"], answer: 1, note: "Croute (ecorce), manteau (81% du volume), noyau (externe liquide + interne solide). Separes par des discontinuites." },
    { q: "Le noyau terrestre est compose de :", choices: ["Silicium et oxygene", "Granite et basalte", "Fer (80%) et nickel (20%)", "Peridotite et olivine"], answer: 2, note: "Noyau : Fe (80%) + Ni (20%). Noyau externe liquide (5000 C) -> champ magnetique. Noyau interne solide." },
    { q: "Le Big Bang est :", choices: ["Une explosion volcanique", "Un modele cosmologique decrivant l'origine de l'Univers il y a ~13,7 milliards d'annees", "La formation du systeme solaire uniquement", "Une theorie sur l'origine de la vie"], answer: 1, note: "Big Bang (~13,7 Ga) : toute la matiere de l'Univers formee lors d'un evenement explosif. Propose par Georges Lemaitre." },
    { q: "Qu'appelle-t-on crise biologique ?", choices: ["Une periode de forte speciation", "Une periode durant laquelle de nombreuses especes disparaissent simultanement", "Une glaciation mondiale", "Une eruption volcanique massive"], answer: 1, note: "Crises majeures : P/T (Permien-Trias, ~250 Ma) et K/T (Cretace-Tertiaire, ~66 Ma)." },
    { q: "Le cratere de Chicxulub est associe a :", choices: ["Une eruption volcanique", "L'impact d'une meteorite >10 km il y a ~65 Ma — responsable de la crise K/T", "Un seisme de magnitude 9", "La formation des Rocheuses"], answer: 1, note: "Chicxulub : Yucatan, Mexique. Impact equivalent a ~1 million de bombes atomiques -> extinctions massives." },
    { q: "Les eres geologiques en ordre decroissant d'anciennete sont :", choices: ["Primaire, Secondaire, Tertiaire, Quaternaire, Precambrien", "Precambrien, Primaire, Secondaire, Tertiaire, Quaternaire", "Quaternaire, Tertiaire, Secondaire, Primaire, Precambrien", "Secondaire, Primaire, Tertiaire, Quaternaire"], answer: 1, note: "Precambrien (4500-570 Ma) -> Primaire (570-240 Ma) -> Secondaire (240-65 Ma) -> Tertiaire (65-present) -> Quaternaire." },
    { q: "L'ere Secondaire (Mesozoique) est connue pour :", choices: ["L'apparition des trilobites", "Le regne des grands reptiles (dinosaures) de -240 a -65 Ma", "L'apparition de l'homme", "Les premieres glaciations"], answer: 1, note: "Mesozoique : Trias, Jurassique, Cretace. Domine par les dinosaures. Se termine par la crise K/T." },
    { q: "Qu'est-ce qu'une glaciation ?", choices: ["Une desertification mondiale", "Une periode durant laquelle une importante partie du globe est recouverte de glace", "Une periode interglaciaire chaude", "Un phenomene regional uniquement"], answer: 1, note: "Glaciation : T basse -> inlandsis, baisse niveau de la mer, modifications biodiversite, mouvements tectoniques verticaux." },
    { q: "L'interglaciaire actuel s'appelle :", choices: ["Le Pleistocene", "Le Miocene", "L'Holocene — depuis la fin de la derniere glaciation il y a ~11 700 ans", "Le Pliocene"], answer: 2, note: "Holocene : periode interglaciaire actuelle depuis ~11 700 ans (fin glaciation de Wurm)." },
    { q: "La lignee humaine comprend dans l'ordre :", choices: ["Homo sapiens -> Australopitheques", "Australopitheques -> Homo habilis -> Homo erectus -> Neandertal -> Homo sapiens", "Homo erectus -> Australopitheques -> Homo sapiens", "Chimpanzes -> Homo habilis -> Homo sapiens"], answer: 1, note: "Hominisation : Australopitheques (~4 Ma) -> Homo habilis (~2,5 Ma) -> Homo erectus (~1,8 Ma) -> Neandertal (~110 000 ans) -> Homo sapiens." },
    { q: "L'etape essentielle de l'hominisation est :", choices: ["Le langage articule", "L'acquisition de la bipedie permanente", "La fabrication d'outils en metal", "L'apparition de la conscience"], answer: 1, note: "Bipedie permanente : premiere caracteristique de la lignee humaine. Entraine modifications du bassin, colonne vertebrale, trou occipital." },
    { q: "L'effet de serre est :", choices: ["Un phenomene uniquement artificiel", "Le rechauffement de la Terre par des gaz captant les rayonnements infrarouges — naturellement indispensable a la vie", "La destruction de la couche d'ozone", "Le refroidissement par les nuages"], answer: 1, note: "Effet de serre naturel : sans lui, T moyenne = -18 C (au lieu de +15 C). Activites humaines l'amplifient -> rechauffement." },
    { q: "Les principaux gaz a effet de serre naturels sont :", choices: ["CFC et HCFC uniquement", "H2O (vapeur d'eau), CO2, CH4, N2O", "O3 et NO2 uniquement", "SF6 et CF4"], answer: 1, note: "GES naturels : H2O, CO2, CH4, N2O. CO2 responsable de 63% du rechauffement anthropique." },
    { q: "La montee du niveau des mers est causee par :", choices: ["L'augmentation des precipitations", "Le rechauffement climatique -> dilatation thermique de l'eau + fonte des glaces terrestres", "La diminution de la couche d'ozone", "L'erosion cotiere"], answer: 1, note: "Montee des mers : dilatation thermique + fonte glaciers/calottes. Consequences : destruction villes cotieres, inondations." },
    { q: "La deforestation accelere le rechauffement car :", choices: ["Les arbres produisent du CO2", "Les forets stockent 20 a 50 fois plus de CO2 que tout autre ecosysteme — leur destruction prive l'atmosphere de ce puits de carbone", "Les arbres augmentent la temperature", "La deforestation produit de la vapeur d'eau"], answer: 1, note: "Forets : puits de carbone. Deforestation -> liberation CO2 stocke + perte capacite d'absorption. En Haiti : consequences catastrophiques." },
## ],
};
