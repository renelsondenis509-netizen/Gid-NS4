...
const handleDeleteAccount = async () => {
  ...
  <button onClick={handleDeleteAccount} style={{ color:"#3B5BA8", fontSize:12, background:"none", border:"none", padding:0, cursor:"pointer", fontFamily:"inherit" }}>🗑️ Efase kont mwen</button>
