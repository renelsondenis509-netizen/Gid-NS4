  ...
  return (
    <div className="fixed inset-0 flex flex-col" style={{ background: "linear-gradient(145deg,#04081A,#080E24)" }}>
      ...
      <div className="px-4 pb-4 space-y-3">
        ...
        <button onClick={handleDeleteAccount} className="w-full py-2 rounded-xl font-semibold" style={{ fontSize:14, background:"#d4002a08", border:"1px solid #d4002a20", color:"#ff6b6b" }}>
  🗑️ Efase kont mwen
</button>
